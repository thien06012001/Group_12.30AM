        ...
        <div className='relative z-30 cursor-pointer grid grid-cols-3 w-[50%] ml-[25%] h-[600px]  '>
            ...
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>Reactjs</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>GitHub</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>JavaScript</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>Nodejs</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>Vercel</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>Sanity</p>
                        </div>
                </motion.div>
            </div>
            <div className='group relative flex cursor-pointer m-auto'>
                ...
                <motion.div
                    ...
                    md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
                        <div className='flex items-center justify-center m-auto h-full'>
                            <p className='text-2xl font-bold text-black opacity-100'>Nextjs</p>
                        </div>
                </motion.div>
            </div>
        </div>
